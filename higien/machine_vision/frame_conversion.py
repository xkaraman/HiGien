...
class Subscriber(Node):
    ...
    def __init__(self):
        ...
        self.data = pd.read_csv(self.camera_file, delimiter=';')
        self.line_number = self.line_count(self.camera_file)
        ...
        try:
            for x, y in zip(self.data['X'], self.data['Y']):
                ...
                if x == 0.0 and y == 0.0:
                    ...
                    trans = self.buffer.lookup_transform('map', 'camera_link', rclpy.time.Time())
